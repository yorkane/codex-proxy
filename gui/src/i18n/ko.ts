...
"dash.disableOriginCheckHint": "Disable all origin/CORS checks so an external reverse proxy can reach the dashboard and API. Use with care.",  "dash.searchModelHint": "비-OpenAI 라우팅 모델의 web_search에 사용되는 모델입니다. ChatGPT 로그인 필요.",
