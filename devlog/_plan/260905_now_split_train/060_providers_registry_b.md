...
ssh lidge 'cd ~/ocx-ci/opencodex && git fetch origin codex/split-providers-registry-b && git checkout -q FETCH_HEAD && bun install --frozen-lockfile >/dev/null && bun run test 2>&1 | tail -15'
```
