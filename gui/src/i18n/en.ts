...
"dash.disableOriginCheckHint": "Disable all origin/CORS checks so an external reverse proxy can reach the dashboard and API. Use with care.",  "dash.searchModel": "Search sidecar model",
