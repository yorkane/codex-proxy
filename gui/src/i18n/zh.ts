...
"common.discard": "丢弃",
 ...
 "dash.codexAutoStartHint": "允许已安装的 launcher shim 运行 ocx ensure。此设置不会安装重启保护；请在启动安全中检查实际状态。",
  "dash.managementAuthDisabled": "禁用管理 API 认证",
  "dash.managementAuthDisabledHint": "跳过 /api/* 的 admin token，使仪表盘和 API 无需凭证即可访问。仅限 loopback 绑定。",
"dash.disableOriginCheck": "关闭 origin 检查",
"dash.disableOriginCheckHint": "关闭所有 origin/CORS 检查，允许外部反向代理访问仪表盘和 API。谨慎使用。",  "dash.searchModel": "搜索附属模型",
